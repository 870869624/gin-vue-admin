  ...
  <div>
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="平台名称" prop="platformName">
         <el-input v-model="searchInfo.platformName" placeholder="搜索条件" />
            ...
            <el-select v-model="searchInfo.platformIsShow" clearable placeholder="请选择">
                <el-option
                    key="true"
                    label="是"
                    value="true">
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="PlatformV1_Platform" />
            <ExportExcel  template-id="PlatformV1_Platform" />
            <ImportExcel  template-id="PlatformV1_Platform" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <el-table-column label="平台图片" prop="platformPicture" width="200">
              <template #default="scope">
                <el-image preview-teleported style="width: 100px; height: 100px" :src="getUrl(scope.row.platformPicture)" fit="cover"/>
              </template>
          </el-table-column>
        <el-table-column align="left" label="平台是否展示" prop="platformIsShow" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.platformIsShow) }}</template>
        </el-table-column>
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updatePlatformFunc(scope.row)">编辑</el-button>
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="平台图片:"  prop="platformPicture" >
                <SelectImage
                 v-model="formData.platformPicture"
                 file-type="image"
                />
            </el-form-item>
            <el-form-item label="平台是否展示:"  prop="platformIsShow" >
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="平台图片">
                            <el-image style="width: 50px; height: 50px" :preview-src-list="returnArrImg(detailFrom.platformPicture)" :src="getUrl(detailFrom.platformPicture)" fit="cover" />
                    </el-descriptions-item>
                    <el-descriptions-item label="平台是否展示">
                        {{ detailFrom.platformIsShow }}
                    </el-descriptions-item>
...
const onSubmit = () => {
  elSearchFormRef.value?.validate(async(valid) => {
    if (!valid) return
    page.value = 1
    if (searchInfo.value.platformIsShow === ""){
        searchInfo.value.platformIsShow=null
    }
    getTableData()
  })
}
