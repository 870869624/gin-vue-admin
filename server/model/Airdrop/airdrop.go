...
type Airdrop struct {
	...
	DistributionDate *time.Time `json:"distributionDate" form:"distributionDate" gorm:"column:distribution_date;comment:空投项目分发日期;" binding:"required"`
}
...
type MobileAirdropResp struct {
	...
	DistributionDate unixTime.UnixTime  `json:"distributionDate" form:"distributionDate" gorm:"column:distribution_date;comment:空投项目分发日期;" binding:"required"`
}
...
type MobileAirdropCre struct {
	...
	DistributionDate string   `json:"distributionDate" form:"distributionDate" gorm:"column:distribution_date;comment:空投项目分发日期;" binding:"required"`
}
